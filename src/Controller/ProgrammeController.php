...
public function index(ProgrammeRepository $programmeRepository, UtilisateurRepository $utilisateurRepository, Request $request, EntityManagerInterface $entityManager): Response
{
    ...
    $queryBuilder = $entityManager->getRepository(Programme::class)->createQueryBuilder('p')
